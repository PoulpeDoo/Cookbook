...
namespace WindowsFormsApplication1 {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TableRow AddTableRow(string Name, string Opicanie, string Time) {
...
namespace WindowsFormsApplication1.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Opicanie = 1 AND [Opicanie] IS NULL) OR ([Opicanie] = @Original_Opicanie)) AND ((@IsNull_Time = 1 AND [Time] IS NULL) OR ([Time] = @Original_Time)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Name], [Opicanie], [Time]) VALUES (@Name, @Opicanie, " +
                "@Time);\r\nSELECT Id, Name, Opicanie, Time FROM [Table] WHERE (Id = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Name] = @Name, [Opicanie] = @Opicanie, [Time] = @Time WHERE (([Id] = @Original_Id) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Opicanie = 1 AND [Opicanie] IS NULL) OR ([Opicanie] = @Original_Opicanie)) AND ((@IsNull_Time = 1 AND [Time] IS NULL) OR ([Time] = @Original_Time)));
SELECT Id, Name, Opicanie, Time FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Opicanie, Time FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Opicanie, string Original_Time) {
        ...
        public virtual int Insert(string Name, string Opicanie, string Time) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Opicanie, string Time, int Original_Id, string Original_Name, string Original_Opicanie, string Original_Time, int Id) {
            if ((Name == null)) {
            ...
            if ((Original_Opicanie == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Opicanie));
            }
            if ((Original_Time == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Opicanie, string Time, int Original_Id, string Original_Name, string Original_Opicanie, string Original_Time) {
            return this.Update(Name, Opicanie, Time, Original_Id, Original_Name, Original_Opicanie, Original_Time, Original_Id);
        }
    }
